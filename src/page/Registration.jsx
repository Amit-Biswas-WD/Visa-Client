    ...
    <div className="container mx-auto">
      ...
      <div className="hero bg-base-200 min-h-screen">
        <div className="card bg-base-100 w-full max-w-xl my-8 shrink-0 shadow-2xl">
          ...
          <div className="flex gap-6 mb-6 ml-10">
            <button
              onClick={handleGoogle}
              className="flex btn items-center gap-2 px-3 py-1 bg-white border border-gray-300 hover:bg-gray-100 text-gray-700 rounded-md shadow-md"
            >
